...
nmapd("<Esc>", "<cmd>nohlsearch<CR>", "Partial Fill norm")

-- TODO: move to Oil keybinds
nmapd("<leader>pv", ":Oil<CR>", "[P]roject [V]iew")
...
-- delete K -> <man> in normal mode
-- I use it a lot for LSP and when no server configured it uses man which is annoying
...
nmapd("<leader>ra", [[:%s/\<<C-r><C-w>\>//gI<Left><Left><Left>]], "[R]eplace [A]ll occurences under cursor")
